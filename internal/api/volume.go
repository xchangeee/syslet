...
func (s *VolumeSpec) ShouldDeleteOnRemoval(sd *systemd.Client) bool {
...
func (s *VolumeSpec) ShouldRemoveOnPrune(sd *systemd.Client) bool {
	content, err := sd.ReadUnitFile(s.FullUnitName())
	if err != nil {
		return false
	}
...
func (s *VolumeSpec) Render() (RenderedUnit, error) {
